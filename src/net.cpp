...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "ChanceCoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"chancecointools.com", "dnsseed.chancecointools.com"},
    {"chancecoinpool.org", "dnsseed.chancecoinpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"chancecointools.com", "testnet-seed.chancecointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. ChanceCoin is probably already running."), addrBind.ToString().c_str());
        else
