...
bool CWallet::CreateWager(int64 nValue,double odds,CWalletTx& wtxNew, CReserveKey& reservekey, int64& nFeeRet, std::string& strFailReason, const CCoinControl *coinControl)
{
    if (nValue < 0)
    {
